 ...
 */
@TlvMsg(moduleId = 0xB400, msgCode = 0x1007)
public class VoiceMessageReq extends TlvSignal {
	...
	public String toString() {
		return "VoiceMessageReq [troopsId=" + troopsId + ", yunvaId=" + yunvaId
				+ ", msg=" + Arrays.toString(msg) + ", expand=" + expand + "]";
	}
