...
@TlvMsg(moduleId = 0x2000, msgCode = 0x0052)
public class ThirdAuthResp extends TlvSignal {
	...
	public String toString() {
		return "ThirdAuthResp [result=" + result + ", msg=" + msg
				+ ", yunvaId=" + yunvaId + ", phone=" + phone + ", nickName="
				+ nickName + ", sex=" + sex + ", birthday=" + birthday
				+ ", email=" + email + ", accountType=" + accountType
				+ ", iconUrl=" + iconUrl + ", signature=" + signature
				+ ", currentProvince=" + currentProvince + ", currentCity="
				+ currentCity + ", birthProvince=" + birthProvince
				+ ", birthCity=" + birthCity + ", school=" + school
				+ ", industry=" + industry + ", intro=" + intro + ", star="
				+ star + ", hobby=" + hobby + ", thirdId=" + thirdId
				+ ", thirdUserId=" + thirdUserId + ", thirdUserName="
				+ thirdUserName + ", qq=" + qq + ", weixin=" + weixin
				+ ", weibo=" + weibo + ", token=" + token + "]";
	}
